...
const LatLng DEST_LOCATION = LatLng(37.193059697980225, 127.0682184165982);
const double CAMERA_ZOOM = 14.8;
const double CAMERA_TILT = 80;
const double CAMERA_BEARING = 30;

class Hos6Page extends StatefulWidget {
  const Hos6Page({super.key});

  @override
  State<Hos6Page> createState() => _Hos1PageState();
}

class _Hos1PageState extends State<Hos6Page> {
