...
const LatLng DEST_LOCATION = LatLng(37.19391429999947, 127.0691321539402);
const double CAMERA_ZOOM = 15;
const double CAMERA_TILT = 80;
const double CAMERA_BEARING = 30;

class Hos4Page extends StatefulWidget {
  const Hos4Page({super.key});

  @override
  State<Hos4Page> createState() => _Hos1PageState();
}

class _Hos1PageState extends State<Hos4Page> {
