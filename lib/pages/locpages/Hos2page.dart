...
const LatLng DEST_LOCATION = LatLng(37.216206158485214, 127.08050564732224);
const double CAMERA_ZOOM = 14;
const double CAMERA_TILT = 80;
const double CAMERA_BEARING = 30;

class Hos2Page extends StatefulWidget {
  const Hos2Page({super.key});

  @override
  State<Hos2Page> createState() => _Hos2PageState();
}

class _Hos2PageState extends State<Hos2Page> {
