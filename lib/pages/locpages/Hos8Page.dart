...
const LatLng DEST_LOCATION = LatLng(37.20865555213807, 127.05819815263605);
const double CAMERA_ZOOM = 14;
const double CAMERA_TILT = 80;
const double CAMERA_BEARING = 30;

class Hos8Page extends StatefulWidget {
  const Hos8Page({super.key});

  @override
  State<Hos8Page> createState() => _Hos1PageState();
}

class _Hos1PageState extends State<Hos8Page> {
