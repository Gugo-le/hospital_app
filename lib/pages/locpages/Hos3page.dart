...
const LatLng DEST_LOCATION = LatLng(37.19433599999978, 127.07192514596788);
const double CAMERA_ZOOM = 15;
const double CAMERA_TILT = 80;
const double CAMERA_BEARING = 30;

class Hos3Page extends StatefulWidget {
  const Hos3Page({super.key});

  @override
  State<Hos3Page> createState() => _Hos1PageState();
}

class _Hos1PageState extends State<Hos3Page> {
